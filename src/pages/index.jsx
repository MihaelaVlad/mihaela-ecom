...
const Home = () => {
  return (
    <>
      ...
      <main className="bg-slate-900 h-screen flex flex-col justify-center items-center gap-y-10">
        <h1 className="font-bold text-4xl text-center text-slate-100 hover:bg-sky-500 p-4 rounded-xl">
          Homepage
        </h1>

        <figure className="bg-slate-100 rounded-xl p-8 dark:bg-slate-800 hover:bg-slate-600 w-1/2 text-center">
          <Image
